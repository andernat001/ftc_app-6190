 ...
 */
@Autonomous(name = "RelicBlueBackPark", group = "RiderModes")
public class CyberRelicBlueBackPark extends CyberRelicAbstract {
    ...
    public void loop(){
        switch (seqRobot) {
            ...
            case 2:
                ...
                servoGem.setPosition(.8);
                motorGlyphLift.setTargetPosition(-2500);
                motorGlyphLift.setPower(.9);
